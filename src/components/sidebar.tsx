    ...
    <aside>
      <nav className="flex flex-col gap-5 px-5 py-7 h-full">
        ...
        <ul className="nav-links grow flex flex-col gap-1">
          <li>
            <Link href="/" className="flex items-center gap-3 w-44 bg-primary px-4 py-3 rounded-sm text-sm text-white ">
              <LayoutDashboard size={15} strokeWidth={3} />
              Beranda
            </Link>
          </li>
          <li>
            <Link href="/arus-kas" className="flex items-center gap-3 w-44 px-4 py-3 rounded-sm text-sm text-slate-600">
              <HandCoins size={15} strokeWidth={2} />
              Arus Kas
            </Link>
          </li>
          <li>
            <Link href="/kalender" className="flex items-center gap-3 w-44 px-4 py-3 rounded-sm text-sm text-slate-600">
              <Calendar size={15} strokeWidth={2} />
              Kalender
            </Link>
          </li>
        </ul>
        <Link href={"#"} className="flex items-center gap-2 w-44 px-4 py-3 text-sm text-red-500">
